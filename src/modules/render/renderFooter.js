...
const footerItem = createElement('div', 
{
...
const footerTitle = createElement('h2', 
{
...
for(const genderName in DATA.navigation) {
  createElement('li', {className: 'footer-category__item'}, {
    ...
    appends: [
      createElement('h3', {className: 'footer-category__subtitle'}, {
...
const footerSocialTitle= createElement('h2', 
{
...
const footerSubtitle= createElement('p', 
{
...
const footerSocialList= createElement('ul', 
{
...
const footerSocialItem= createElement('li', 
{
  className: 'footer-social__item',
},
{
  parent: footerSocialList,
},
);
const footerSocialLink= createElement('a', 
{
...
{
  parent: footerSocialItem,
},
);
const footerSocialItem1= createElement('li', 
{
  className: 'footer-social__item',
},
{
...
const footerSocialLink1 = createElement('a', 
{
...
{
  parent: footerSocialItem1,
},
);
const footerItemContacts= createElement('div', 
{
...
{
  className: 'footer__link',
  textContent: '8 029 375 59 06',
  href:`tel:80293755906`
},
{
  parent: footerItemContacts,
},
);
const footerLink3 = createElement('a', 
{
  className: 'footer__link',
...
const footerItemCopyright= createElement('div', 
{
...
{
  parent: footerItemCopyright,
},
);
const footerItemDevelopment= createElement('div', 
{
...
const footerDevelopmentList= createElement('ul', 
{
  className: 'footer-development__list',
},
{
  parent: footerItemDevelopment,
},
);
const footerDevelopment= createElement('li', 
{
  className: 'footer-development',
},
{
  parent: footerDevelopmentList,
},
);
const footerLink1 = createElement('a', 
{
  className: 'footer__link',
...
const footerDevelopment1= createElement('li', 
{
  className: 'footer-development',
},
{
...
const footerLink2 = createElement('a', 
{
  className: 'footer__link',
  textContent: `Developer: Zolotarev Pavel `,
  href: "https://t.me/s0luver",
},
{
  parent: footerDevelopment1,
},
);
}